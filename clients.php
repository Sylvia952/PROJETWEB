...
if (isset($_GET['delete'])) {
    if ($_SESSION['role'] !== 'admin') {
        die("Accès refusé : vous n'êtes pas autorisé à supprimer ce client.");
    }
...
<header class="bg-white shadow-sm p-4 flex justify-between items-center">
    <h2 class="text-xl font-semibold text-blue-800"><i data-feather="users" class="inline mr-2"></i> Gestion des clients</h2>
